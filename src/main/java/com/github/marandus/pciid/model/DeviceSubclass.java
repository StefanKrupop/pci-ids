...
public class DeviceSubclass implements Comparable<DeviceSubclass> {
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        final DeviceSubclass other = (DeviceSubclass) o;
    ...
    protected boolean canEqual(final java.lang.Object other) {
        return other instanceof DeviceSubclass;
    }
    ...
    public java.lang.String toString() {
        return "DeviceSubclass(id=" + this.getId() + ", name=" + this.getName() + ", comment=" + this.getComment() + ", programInterfaces=" + this.getProgramInterfaces() + ", numericId=" + this.numericId + ")";
    }
}
